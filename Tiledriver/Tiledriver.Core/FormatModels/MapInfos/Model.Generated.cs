...
namespace Tiledriver.Core.FormatModels.MapInfos
{
    ...
    public sealed partial class GameInfo
    {
        ...
        public GameInfo WithPlayerClassess( IEnumerable<string> playerClassess )
        {
            return new GameInfo(
                advisoryColor: AdvisoryColor,
                advisoryPic: AdvisoryPic,
        ...
        public GameInfo WithAdditionalPlayerClasses( string playerClasses )
        {
            return new GameInfo(
                advisoryColor: AdvisoryColor,
                advisoryPic: AdvisoryPic,
        ...
        public GameInfo WithQuitMessagess( IEnumerable<string> quitMessagess )
        {
            return new GameInfo(
                advisoryColor: AdvisoryColor,
                advisoryPic: AdvisoryPic,
        ...
        public GameInfo WithAdditionalQuitMessages( string quitMessages )
        {
            return new GameInfo(
                advisoryColor: AdvisoryColor,
                advisoryPic: AdvisoryPic,
        ...
        public GameInfo WithGameInfo( GameInfo gameInfo )
        {
            return new GameInfo(
                ...
                playerClassess: PlayerClassess.AddRange(gameInfo.PlayerClassess),
                pushwallSoundSequence: gameInfo.PushwallSoundSequence.Or(PushwallSoundSequence),
                quitMessagess: QuitMessagess.AddRange(gameInfo.QuitMessagess),
    ...
    public sealed partial class DefaultMap : BaseMap
    {
        ...
        public DefaultMap WithEnsureInventorys( IEnumerable<string> ensureInventorys )
        {
            return new DefaultMap(
                borderTexture: BorderTexture,
                cluster: Cluster,
    ...
    public sealed partial class AddDefaultMap : BaseMap
    {
        ...
        public AddDefaultMap WithEnsureInventorys( IEnumerable<string> ensureInventorys )
        {
            return new AddDefaultMap(
                borderTexture: BorderTexture,
                cluster: Cluster,
    ...
    public sealed partial class Map : BaseMap
    {
        ...
        public Map WithEnsureInventorys( IEnumerable<string> ensureInventorys )
        {
            return new Map(
                borderTexture: BorderTexture,
                cluster: Cluster,
