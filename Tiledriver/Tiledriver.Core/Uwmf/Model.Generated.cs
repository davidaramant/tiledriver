...
namespace Tiledriver.Core.Uwmf
{
    public sealed partial class Tile : BaseUwmfBlock, IWriteableUwmfBlock
    {
        ...
        public Stream WriteTo(Stream stream)
        {
            ...
            if (BlockingEast != true) WriteProperty(stream, "blockingEast", BlockingEast, indent: true);
            if (BlockingNorth != true) WriteProperty(stream, "blockingNorth", BlockingNorth, indent: true);
            if (BlockingWest != true) WriteProperty(stream, "blockingWest", BlockingWest, indent: true);
            if (BlockingSouth != true) WriteProperty(stream, "blockingSouth", BlockingSouth, indent: true);
            if (OffsetVertical != false) WriteProperty(stream, "offsetVertical", OffsetVertical, indent: true);
            if (OffsetHorizontal != false) WriteProperty(stream, "offsetHorizontal", OffsetHorizontal, indent: true);
            if (DontOverlay != false) WriteProperty(stream, "dontOverlay", DontOverlay, indent: true);
            if (Mapped != 0) WriteProperty(stream, "mapped", Mapped, indent: true);
            if (SoundSequence != "") WriteProperty(stream, "soundSequence", SoundSequence, indent: true);
            if (TextureOverhead != "") WriteProperty(stream, "textureOverhead", TextureOverhead, indent: true);
        ...
        {
            if (!_textureEastHasBeenSet) throw new InvalidUwmfException("Did not set TextureEast on Tile");
            if (!_textureNorthHasBeenSet) throw new InvalidUwmfException("Did not set TextureNorth on Tile");
            if (!_textureWestHasBeenSet) throw new InvalidUwmfException("Did not set TextureWest on Tile");
            if (!_textureSouthHasBeenSet) throw new InvalidUwmfException("Did not set TextureSouth on Tile");
            AdditionalSemanticChecks();
        }
    ...
    public sealed partial class Sector : BaseUwmfBlock, IWriteableUwmfBlock
    {
        ...
        public void CheckSemanticValidity()
        {
            if (!_textureCeilingHasBeenSet) throw new InvalidUwmfException("Did not set TextureCeiling on Sector");
            if (!_textureFloorHasBeenSet) throw new InvalidUwmfException("Did not set TextureFloor on Sector");
            AdditionalSemanticChecks();
        }
    ...
    public sealed partial class Plane : BaseUwmfBlock, IWriteableUwmfBlock
    {
        ...
        public void CheckSemanticValidity()
        {
            if (!_depthHasBeenSet) throw new InvalidUwmfException("Did not set Depth on Plane");
            AdditionalSemanticChecks();
        }
    ...
    public sealed partial class TileSpace : BaseUwmfBlock
    {
        ...
        public void CheckSemanticValidity()
        {
            if (!_tileHasBeenSet) throw new InvalidUwmfException("Did not set Tile on TileSpace");
            if (!_sectorHasBeenSet) throw new InvalidUwmfException("Did not set Sector on TileSpace");
            if (!_zoneHasBeenSet) throw new InvalidUwmfException("Did not set Zone on TileSpace");
            AdditionalSemanticChecks();
        }
    ...
    public sealed partial class Thing : BaseUwmfBlock, IWriteableUwmfBlock
    {
        ...
        public Stream WriteTo(Stream stream)
        {
            ...
            if (Patrol != false) WriteProperty(stream, "patrol", Patrol, indent: true);
        ...
        public void CheckSemanticValidity()
        {
            if (!_typeHasBeenSet) throw new InvalidUwmfException("Did not set Type on Thing");
            if (!_xHasBeenSet) throw new InvalidUwmfException("Did not set X on Thing");
            if (!_yHasBeenSet) throw new InvalidUwmfException("Did not set Y on Thing");
            if (!_zHasBeenSet) throw new InvalidUwmfException("Did not set Z on Thing");
            if (!_angleHasBeenSet) throw new InvalidUwmfException("Did not set Angle on Thing");
            AdditionalSemanticChecks();
        }
    ...
    public sealed partial class Trigger : BaseUwmfBlock, IWriteableUwmfBlock
    {
        ...
        public Stream WriteTo(Stream stream)
        {
            ...
            if (ActivateEast != true) WriteProperty(stream, "activateEast", ActivateEast, indent: true);
            if (ActivateNorth != true) WriteProperty(stream, "activateNorth", ActivateNorth, indent: true);
            if (ActivateWest != true) WriteProperty(stream, "activateWest", ActivateWest, indent: true);
            if (ActivateSouth != true) WriteProperty(stream, "activateSouth", ActivateSouth, indent: true);
            if (PlayerCross != false) WriteProperty(stream, "playerCross", PlayerCross, indent: true);
            if (PlayerUse != false) WriteProperty(stream, "playerUse", PlayerUse, indent: true);
            if (MonsterUse != false) WriteProperty(stream, "monsterUse", MonsterUse, indent: true);
            if (Repeatable != false) WriteProperty(stream, "repeatable", Repeatable, indent: true);
        ...
        public void CheckSemanticValidity()
        {
            if (!_xHasBeenSet) throw new InvalidUwmfException("Did not set X on Trigger");
            if (!_yHasBeenSet) throw new InvalidUwmfException("Did not set Y on Trigger");
            if (!_zHasBeenSet) throw new InvalidUwmfException("Did not set Z on Trigger");
            if (!_actionHasBeenSet) throw new InvalidUwmfException("Did not set Action on Trigger");
            AdditionalSemanticChecks();
        }
