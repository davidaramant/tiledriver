        ...
        public static readonly IEnumerable<BlockData> Blocks = new[]
        {
            ...
            new BlockData("gameinfo",className:"gameInfo",
                properties:new[]
                {
                    ...
                    new PropertyData(formatName:"playerclasses", name:"playerClasses", type:PropertyType.StringList),
                    new PropertyData(formatName:"pushwallsoundsequence", name:"pushwallSoundSequence", type:PropertyType.String),
                    new PropertyData(formatName:"quitmessages", name:"quitMessages", type:PropertyType.StringList),
            ...
            new BlockData("defaultmap",className:"defaultMap",
                properties:new []
                {
                    ...
                    new PropertyData(formatName:"ensureinventory",name:"ensureInventory",type:PropertyType.StringList),
                    ...
                    new PropertyData(formatName:"specialaction",name:"specialAction",type:PropertyType.BlockList),
            ...
            new BlockData("mapInfo",
                ...
                properties:new []
                {
                    new PropertyData("cluster",type:PropertyType.BlockList),
                    new PropertyData("episode",type:PropertyType.BlockList),
                    new PropertyData("gameInfo",formatName:"gameinfo",type:PropertyType.Block),
                    new PropertyData("intermission",type:PropertyType.BlockList),
                    new PropertyData("map",type:PropertyType.BlockList),
                }),
        };
    }
}
