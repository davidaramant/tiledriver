        ...
        public static IEnumerable<Block> Blocks()
        {
            yield return new Block("cluster",
                     ...
                     properties: new[]
                     {
                        ...
                        new Property(formatName: "exittext", name: "exitText", type: PropertyType.Block,
                            collectionType: "ClusterExitText"),
                        new Property(formatName: "exittextislump", name: "exitTextIsLump", type: PropertyType.Flag,
                            defaultValue: false),
                        new Property(formatName: "exittextismessage", name: "exitTextIsMessage", type: PropertyType.Flag,
                            defaultValue: false),
                     });
            ...
            yield return new Block("gameinfo", className: "GameInfo",
                    ...
                    properties: new[]
                    {
                        ...
                        new Property(formatName: "doorsoundsequence", name: "doorSoundSequence",
                        ...
                        new Property(formatName: "highscoresfontcolor", name: "highScoresFontColor",
                            type: PropertyType.String),
                        new Property(formatName: "intermissionmusic", name: "intermissionMusic",
                            type: PropertyType.String),
                        ...
                        new Property(formatName: "menufontcolor_disabled", name: "menuFontColorDisabled",
                            type: PropertyType.String),
                        new Property(formatName: "menufontcolor_highlight", name: "menuFontColorHighlight",
                            type: PropertyType.String),
                        new Property(formatName: "menufontcolor_highlightselection",
                            name: "menuFontColorHighlightSelection", type: PropertyType.String),
                        new Property(formatName: "menufontcolor_invalid", name: "menuFontColorInvalid",
                            type: PropertyType.String),
                        new Property(formatName: "menufontcolor_invalidselection", name: "menuFontColorInvalidSelection",
                            type: PropertyType.String),
                        new Property(formatName: "menufontcolor_label", name: "menuFontColorLabel",
                            type: PropertyType.String),
                        new Property(formatName: "menufontcolor_selection", name: "menuFontColorSelection",
                            type: PropertyType.String),
                        new Property(formatName: "menufontcolor_title", name: "menuFontColorTitle",
                            type: PropertyType.String),
                        ...
                        new Property(formatName: "pageindexfontcolor", name: "pageIndexFontColor",
                            type: PropertyType.String),
                        ...
                        new Property(formatName: "pushwallsoundsequence", name: "pushwallSoundSequence",
                            type: PropertyType.String),
