    ...
    static class MapInfoDefinitions
    {
        public static readonly ImmutableArray<IBlock> Blocks = new IBlock[]
        {
            ...
            new AbstractBlock("BaseMap",
                ...
                Properties: new Property[]
                {
                    new NullableStringProperty("borderTexture"),
                    new IntegerProperty("cluster",defaultValue:0),
                    new NullableStringProperty("completionString"),
                    new BooleanProperty("deathCam", defaultValue: false),
                    new NullableStringProperty("defaultCeiling"),
                    new NullableStringProperty("defaultFloor"),
                    new ListProperty("ensureInventory", elementType: "string"),
                    new BlockProperty("exitFade", propertyType: "ExitFadeInfo", nullable:true), // Not actually nullable - default is color 0, duration 30
                    new IntegerProperty("floorNumber", defaultValue:1),
                    new NullableStringProperty("highScoresGraphic"),
                    new IntegerProperty("levelBonus", defaultValue:-1),
                    new IntegerProperty("levelNum", defaultValue:0),
                    new NullableStringProperty("music"),
                    new FlagProperty("spawnWithWeaponRaised"),
                    new BooleanProperty("secretDeathSounds", defaultValue: false),
                    new BlockProperty("next", propertyType: "NextMapInfo", nullable:true),
                    new BlockProperty("secretNext", "NextMapInfo", nullable:true),
                    new BlockProperty("victoryNext", propertyType: "NextMapInfo", nullable:true),
                    new BlockProperty("SpecialActions", propertyType: "ImmutableList<SpecialAction>"),
                    new FlagProperty("noIntermission"),
                    new IntegerProperty("par", defaultValue:0),
                    new NullableStringProperty("translator"),
                }.ToImmutableArray()),
