...
public sealed class SquareSegmentSectorsTests
{
    ...
    public void ShouldDetermineFrontIfBottomIsOutsideLevel()
    {
        ...
        var squareSegments = new SquareSegmentSectors(new[]
        {
        ...
        edges.Keys.Should()
            .BeEquivalentTo(new[] {EdgeSegmentId.HorizontalLeft, EdgeSegmentId.HorizontalRight});
    ...
    public void ShouldDetermineFrontIfLeftIsOutsideLevel()
    {
        ...
        var edges = squareSegments.GetInternalEdges().ToDictionary(e=>e.Id,e=>e);
        edges.Keys.Should()
            .BeEquivalentTo(new[] {EdgeSegmentId.VerticalBottom, EdgeSegmentId.VerticalTop});
