using Tiledriver.FormatModels.Common.BinaryMaps;
using Tiledriver.FormatModels.MapInfo;
using Tiledriver.FormatModels.Uwmf;
using Tiledriver.FormatModels.Xlat;

namespace Tiledriver.MapConversion;

public sealed class BinaryMapTranslator
{
	private readonly MapTranslation _translatorInfo;

	public BinaryMapTranslator(MapTranslation translatorInfo)
	{
